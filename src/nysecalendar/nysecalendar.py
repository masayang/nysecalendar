...
if __name__ == '__main__':
    ...
    # List all NYSE holiday observances for 2023
    print("\nNYSE Holidays in 2023")
    for dy in NYSE_holidays(datetime.date(2023, 1, 1), datetime.date(2023, 12, 31)):
        print(dy.strftime('%b %d %Y'))

    # List all NYSE holiday observances for 2024
    print("\nNYSE Holidays in 2024")
    for dy in NYSE_holidays(datetime.date(2024, 1, 1), datetime.date(2024, 12, 31)):
        print(dy.strftime('%b %d %Y'))
